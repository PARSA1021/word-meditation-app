          ...
          {step === 'info' && (
            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="space-y-6">
                <div className="bg-[#F7F7F7] p-8 rounded-[36px] border border-black/[0.04] relative group">
                  <div className="flex justify-between items-center mb-4">
                    <span className="text-[10px] font-black text-[#0099FF] uppercase tracking-widest px-1">Donation Account</span>
                    <button 
                      onClick={() => {
                        navigator.clipboard.writeText('123-45678-901');
                        alert('계좌번호가 복사되었습니다. 입금 완료 후 다음 페이지에서 알려주시면 됩니다!');
                      }}
                      className="text-[10px] text-[#717171] font-black hover:text-[#0099FF] transition-colors border border-black/[0.05] bg-white px-3 py-1.5 rounded-full shadow-sm active:scale-95"
                    >
                      번호 복사
                    </button>
                  </div>
                  <div className="space-y-1">
                    <h4 className="text-[24px] font-black text-black tracking-tight leading-none">국민은행 123-45678-901</h4>
                    <p className="text-[13px] text-[#717171] font-bold">예금주: 트루패스 (TruePath)</p>
                  </div>
                </div>
