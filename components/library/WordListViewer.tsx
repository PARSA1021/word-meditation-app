...
export default function WordListViewer({ node, isLoading, highlightId}: WordListViewerProps) {
 ...
 <h1 className="heading-xl leading-tight text-slate-900">
 {node.name}
 </h1>
 ...
 <div className="p-12 text-center bg-slate-50 backdrop-blur-sm rounded-[32px] border border-dashed border-slate-200">
