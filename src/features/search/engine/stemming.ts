...
const KOREAN_PARTICLES = [
  "께로부터", "으로부터", "에서부터", "까지도", "으로서", "으로서의", "로서의", "에게서", "한테서",
  "께서", "에서", "에게", "으로", "이나", "이랑", "까지", "부터", "마다", "보다", "조차", "마저", "뿐만", "로서", "한테",
  "은", "는", "이", "가", "을", "를", "에", "와", "과", "도", "만", "로", "의"
].sort((a, b) => b.length - a.length)

const VERB_ENDINGS = [
  "하시었다", "하셨다", "하십니다", "하옵소서", "되셨다", "되시었다",
  "하였습니다", "하였다", "하겠습니다", "하겠다", "합니다", "한다", "해야", "하여", "하는", "하고",
  "하지", "하면", "하니", "하여서", "하니라", "하리라", "하였으니", "하였으며", "하였고", "하느니라", "하시니라",
